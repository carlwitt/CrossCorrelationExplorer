    ...
    */
      public static void main(String[] args)
      {
         ...
         else
         {
            ...
            final DistanceFunction distFn = args.length < 4 ?
                    DistanceFunctionFactory.getDistFnByName("EuclideanDistance") :
                        DistanceFunctionFactory.getDistFnByName(args[3]);

            final TimeWarpInfo info = com.fastdtw.dtw.FastDTW.getWarpInfoBetween(tsI, tsJ, Integer.parseInt(args[2]), distFn);
