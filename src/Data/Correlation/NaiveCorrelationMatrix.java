...
// * @author Carl Witt
// */
//public class NaiveCorrelationMatrix {
//
...
//     */
//    public NaiveCorrelationMatrix(WindowMetadata metadata) {
...
//        NaiveCorrelationMatrix[] partialResults = new NaiveCorrelationMatrix[metadata.setA.size()*metadata.setB.size()];
...
//                WindowMetadata metadata1 = new WindowMetadata(tsA, tsB, metadata.windowSize, metadata.tauMin, metadata.tauMax, metadata.naAction, metadata.baseWindowOffset);
//                partialResults[freeSlot++] = CrossCorrelation.naiveCrossCorrelation(metadata1);
...
//                double mean = 0;
//                for (NaiveCorrelationMatrix partialResult : partialResults) {
...
////        public ComputeService(NaiveCorrelationMatrix input){
////            this.input = input;
////        }
//
//        @Override protected Task<NaiveCorrelationMatrix> createTask() {
//            return new Task<NaiveCorrelationMatrix>() {
//
//                @Override protected NaiveCorrelationMatrix call() {
//
////                    DFT.naAction = metadata.naAction;
//
//                    // check that all time series have the same length?
...
//                            WindowMetadata metadata1 = new WindowMetadata(tsA, tsB, metadata.windowSize, metadata.tauMin, metadata.tauMax, metadata.naAction, metadata.baseWindowOffset);
//                            partialResults[freeSlot++] = CrossCorrelation.naiveCrossCorrelation(metadata1);
////                            partialResults[freeSlot++] = CorrelogramStore.getResult(new WindowMetadata(tsA, tsB, metadata.windowSize, metadata.tauMin, metadata.tauMax, metadata.naAction, metadata.baseWindowOffset));
////if(RuntimeConfiguration.VERBOSE) System.out.println(String.format("%d/%d ",freeSlot,partialResults.length));//,partialResults[freeSlot-1]
//                        }
//                    }
//
...
//                    }
//
//                    NaiveCorrelationMatrix.this.columns = _columns;
//
//                    return NaiveCorrelationMatrix.this;
//                }
//
...
//         * @param windowStartIndex see {@link Data.Correlation.NaiveCorrelationMatrix.Column#windowStartIndex}
//         * @param tauMin
//         */
...
//            return false;
//        }
//        final NaiveCorrelationMatrix other = (NaiveCorrelationMatrix) obj;
//
