...
public class StatisticsForWindowsTest {
    ...
    @Test public void testConstructedProperties(){
        ...
        StatisticsForWindows instance = new StatisticsForWindows(ts, 4, 3, -1, 3, false);
        assertEquals(6, instance.numWindows);
        assertEquals(1, instance.baseWindowOverlap);
        assertEquals(2, instance.sharedLagWindows);
        assertEquals(true, instance.continuousIndices);

        // non-contiuous, non-perfect fit
        instance = new StatisticsForWindows(ts, 4, 3, 0, 1, false);
        ...
        instance = new StatisticsForWindows(ts, 3, 3, -3, 3, false);
        assertEquals(7, instance.numWindows);
        assertEquals(0, instance.baseWindowOverlap);
        assertEquals(4, instance.sharedLagWindows);
        assertEquals(true, instance.continuousIndices);

        // non-continuous, perfect fit, base window not in lag range
        instance = new StatisticsForWindows(ts, 3, 3, 1, 2, false);
        assertEquals(7, instance.numWindows);
        assertEquals(0, instance.baseWindowOverlap);
        assertEquals(-1, instance.sharedLagWindows);
        assertEquals(false, instance.continuousIndices);
        // like above but with mirrored lag range
        instance = new StatisticsForWindows(ts, 3, 3, -2, -1, false);
        assertEquals(7, instance.numWindows);
        assertEquals(0, instance.baseWindowOverlap);
        assertEquals(-1, instance.sharedLagWindows);
        assertEquals(false, instance.continuousIndices);
    ...
    @Test public void testWindowStartIndices(){
        ...
        StatisticsForWindows instance = new StatisticsForWindows(ts, windowSize, delta, tauMin, tauMax, true);
    ...
    @Test public void testStatisticsForWindows(){
        ...
        instance = new StatisticsForWindows(ts, windowSize, delta, tauMin, tauMax, true);
